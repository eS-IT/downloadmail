 ...
 * Content elements
 */
$GLOBALS['TL_LANG']['CTE']['easy_downloadmail'] = ['easy_Downloadmail', 'Mit diesem Element kann ein Download angefordert werden.'];
$GLOBALS['TL_LANG']['CTE']['downloadmail'] = ['Downloadanforderung', 'Anforderung eines Downloads'];
